...
public class Game extends JFrame {
	    ...
	    private boolean[][] isQuestionMarked;  // Vérifie si la case avec un drapeau a été recliquée
    ...
    private void dispatchBombs(int size) {
        ...
        // Le nombre à afficher sur la case selectionnée en fonction du nombre de bombes qui lui sont adjacentes
        for (int i = 0; i < size; i++) {
        for (int j = 0; j < size; j++) {
    ...
    // Fonction qui génère la fenêtre du jeu et ses dépendances
    public void container(Game gameEnclosure, int size) {
        ...
        // Récupération des images des bombes et des drapeaux
        try {
        ...
        // Affichage de la durée totale de la partie en secondes
...
//        gameScore.add(lastScore, BorderLayout.SOUTH);
        ...
        // On ajoute à la fenêtre de l'applcation tous les éléments du jeu
        ...
        // Positionnement aléatoire des bombes en fonction du nombre de cases et du nombre de bombes initialisées
        dispatchBombs(size);
    ...
    // Mise à jour de la durée du jeu toutes les secondes
    ...
    // Vérifie si le nombre des cases montrées est égal au nombre de cases totales du jeu alors le joueur a effectivement gagné
